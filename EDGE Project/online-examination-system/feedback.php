...
<div class="col-md-10">
<a href="mustafizhstu@gmail.com" style="color:#000000">admin@admin.com</a><br /><br />
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <img src="image/CAM00121.png" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
            </div>
            <div class="col-md-5">
              ...
              <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01705899036</h4>
